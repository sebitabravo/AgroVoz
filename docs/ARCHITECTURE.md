...
- `llm_service.py` — interpretación NL + Tool Calling con whitelist (9 tools: get_price, get_price_spread, get_price_history, calculate_sale_value, calculate_margin, get_weather, get_clima_historico, search_corpus, register_expense)
